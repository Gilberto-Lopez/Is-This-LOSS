...
preguntemos si el patrón que, según nosotros, estamos viendo o simplemente estamos perdiendo la cabeza. En otras
...
En este escrito expondremos una manera de tratar de solucionar este tipo de problemas usando redes neuronales
convolucionales.
...
de algún tema, sin importar cual sea este.

En el año 2008 un caricaturista, conocido por hacer caricaturas de humor, se salio totalmente de su estilo al
publicar una imagen divida en cuatro partes, donde se ilustra un momento difícil de su vida (Ver figura 1,
sección 4). Tiempo después los usuarios del internet convirtieron esa deprimente caricatura en un 'meme', y ahí
nació el meme de 'Is this loss?', el cual consiste en una imagen en cuatro partes siguiendo el patrón de la
caricatura original, es decir, en el primer cuadro debe haber algo que asemeje a una persona parada, en el
segundo y tercero a dos personas y en el cuarto a una persona parada y una acostada.

Por la naturaleza del meme, se genero una cantidad impresionante de 'edits' del mismo, en algunas de ellas
es difícil saber si realmente corresponde al patrón o no. Se busca ver si una red neuronal puede identificar memes de este tipo, incluso cuando estos son difíciles de identificar para el ser humano.
