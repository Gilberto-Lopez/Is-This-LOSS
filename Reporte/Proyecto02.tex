...
usuarios puedan dicho patrón.

Por la naturaleza del meme, se genero una cantidad impresionante de ediciones o `edits' del mismo,
y en algunas de ellas es realmente difícil saber si realmente corresponde al patrón o no, pues
